...
- `infer_static_onnx.py` is the recommended static-bucket ONNX path after the frontend length/mask fix.
- `infer_static_axmodel.py` is the deployment-oriented path that mixes ONNX Runtime duration prediction with AXERA static models.
